    ...
    <div className="pt-20 relative">
      ...
      <div className="flex justify-center relative my-20 z-10 flex-col items-center">
        <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center text-center">
          ...
          <TextGenerateEffect
            words="Turning Vision into Engaging Digital Experiences"
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
          />
          <p className="text-center md:tracking-wider text-sm md:text-lg lg:text-2xl">
            Hello! I&apos;m Ahmed Roshdy, a Passionate Web Developer from Egypt.
          </p>
          <div
            className={`relative transition-transform duration-1000 ${
              slideIn ? "translate-x-0" : "translate-x-[100vw]"
            } mt-10 md:mt-20 lg:mt-0`}
          >
            <Image
              src={HeroImg}
              alt="Sliding Hero"
              className="h-[300px] md:h-[400px] w-auto object-cover"
              priority
            />
          </div>

    ...
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
        ...
        <Card
          ...
          description="his is where the magic happens! Based on the approved design, I'll translate everything into functional code, building your website from the ground up."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = ({ order }: { order: string }) => {
  return (
    <div>
      <button className="px-12 py-2 rounded-full relative bg-slate-700 text-white text-3xl font-bold border border-slate-600">
